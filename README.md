...
repository secrets. Attach the `torana.sh` custom domain in Cloudflare Pages after
the first deployment, then update the domain nameservers or the required CNAME at
the registrar.
